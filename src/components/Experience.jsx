        ...
        <section id="experience" className="py-24 px-6 relative z-10">
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center gap-4 mb-12">
                    <h2 className="text-3xl font-bold font-display text-zinc-50">Experience</h2>
                ...
                <div className="bg-zinc-900/50 p-8 rounded-xl border border-zinc-800">
                    <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4">
                        <div>
                            <h3 className="text-xl font-display font-bold text-zinc-50">Web Development Intern</h3>
                            <div className="text-indigo-400 font-medium">Brainy Beam Pvt. Ltd.</div>
                        </div>
                        <div className="text-zinc-500 text-sm mt-2 md:mt-0 font-sans">
                            [Start Date] – [End Date]
                        </div>
                    </div>
                    <ul className="list-disc list-outside ml-4 space-y-2 text-zinc-400 font-sans">
                        <li>Collaborated with the engineering team to build and maintain responsive frontend components.</li>
                        <li>Assisted in integrating RESTful APIs and optimizing application performance.</li>
                        <li>Gained hands-on experience with modern version control and team-based development workflows.</li>
                    </ul>
                </div>
            </div>
        </section>
