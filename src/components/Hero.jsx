...
//     return (
//         <section id="home" className="relative min-h-screen flex items-center justify-center px-6 pt-20 bg-zinc-950">
//             <div className="max-w-6xl w-full z-10 grid md:grid-cols-2 gap-12 items-center">
//                 <div>
//                     <h1 className="hero-element text-5xl md:text-7xl font-bold font-display text-zinc-50 mb-4 tracking-tight">
//                         Soham Gajjar.
//                     </h1>
//                     <h2 className="hero-element text-2xl md:text-3xl font-display text-indigo-400 mb-6">
//                         MERN Stack Developer
//                     </h2>
//                     <p className="hero-element text-lg max-w-lg mb-8 text-zinc-400 leading-relaxed font-sans">
//                         I build clean, scalable web applications. My focus is on writing maintainable code and designing interfaces that feel intuitive and fast.
//                     </p>
//                     <div className="hero-element flex flex-wrap gap-4">
//                         <a href="#projects" className="bg-indigo-500 text-white px-6 py-3 rounded-md font-medium hover:bg-indigo-600 transition-colors">
//                             View Work
//                         </a>
//                         <a href="mailto:sohamgajjar@email.com" className="bg-transparent text-zinc-300 border border-zinc-700 px-6 py-3 rounded-md font-medium hover:border-indigo-500 hover:text-indigo-400 transition-colors">
//                             Get in Touch
//                         </a>
//                     </div>
//                     <div className="hero-element flex gap-6 mt-10">
//                         <a href="https://github.com/sohamgajjar" className="text-zinc-500 hover:text-indigo-400 transition-colors"><GithubIcon size={24} /></a>
//                         <a href="https://linkedin.com/in/sohamgajjar" className="text-zinc-500 hover:text-indigo-400 transition-colors"><LinkedinIcon size={24} /></a>
//                     </div>
//                 </div>

//                 <div className="hero-element hidden md:flex justify-end relative">
//                     <div className="w-80 h-96 relative">
//                         <div className="absolute inset-0 bg-indigo-500/20 translate-x-4 translate-y-4 rounded-xl border border-indigo-500/30"></div>
//                         <img
//                             src="https://placehold.co/600x800/18181b/6366f1?text=Soham+Photo"
//                             alt="Soham Gajjar"
//                             className="absolute inset-0 w-full h-full object-cover rounded-xl grayscale hover:grayscale-0 transition-all duration-500 z-10"
//                         />
//                     </div>
//                 </div>
//             </div>
...
import LiveStackVisualizer from './LiveStackVisualizer';

const Hero = () => {
    const [typedText, setTypedText] = useState('');
    const roles = ["Frontend Developer", "MERN Stack Developer", "React.js Enthusiast", "Open to Internships"];
    const [roleIndex, setRoleIndex] = useState(0);
    const [isDeleting, setIsDeleting] = useState(false);

    useEffect(() => {
        // Adjusted timing: 90ms to type, 35ms to delete
        ...
        <section id="home" className="relative z-10 min-h-screen flex items-start md:items-center justify-center px-6 pt-32 md:pt-20 overflow-hidden">
            <div className="max-w-6xl w-full z-10 grid md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h2 className="hero-element text-2xl md:text-3xl font-display text-indigo-400 mb-6 h-10">
                        {typedText}<span className="animate-pulse">|</span>
                    </h2>
                    <p className="hero-element text-lg max-w-lg mb-10 text-zinc-400 leading-relaxed font-sans">
                        I build clean, scalable web applications. My focus is on writing maintainable code and designing interfaces that feel intuitive and fast.
                    </p>
                    <div className="hero-element flex flex-wrap gap-4">
                        <a href="#projects" className="btn-animated bg-indigo-500 text-white px-6 py-3 rounded-md font-medium text-sm">
                            <span className="btn-animated-text">
                                View Work <ArrowRight size={18} className="btn-animated-icon" />
                            </span>
                        </a>
                        <a href="mailto:sohamgajjar@email.com" className="btn-animated bg-transparent text-zinc-300 border border-zinc-700 px-6 py-3 rounded-md font-medium text-sm hover:border-indigo-500">
                            <span className="btn-animated-text">
                                Get in Touch
                            </span>
                        </a>
